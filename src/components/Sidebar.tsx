...
/** Popular timezones grouped by region (unique IANA IDs per region). */
...
/** Sidebar showing popular timezones by region with UTC offsets. */
export function Sidebar({ baseTime }: SidebarProps) {
  return (
